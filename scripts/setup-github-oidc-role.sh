...
echo "Set production SST secrets once:"
echo "  npx sst secret set PostgresPassword \"<value>\" --stage=production"
echo "  npx sst secret set JwtSecret \"<value>\" --stage=production"
echo "  npx sst secret set SesSenderEmail \"<email>\" --stage=production"
echo "  npx sst secret set SeedAdminEmail \"<email>\" --stage=production"
echo "  npx sst secret set SeedAdminPassword \"<value>\" --stage=production"
echo "  npx sst secret set SeedAdminFirstName \"Admin\" --stage=production"
echo "  npx sst secret set SeedAdminLastName \"User\" --stage=production"
